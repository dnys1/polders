function polders(K_goal, z)
% Run the simulation using the goal maintenance level K_goal and external
% wage rate z, i.e. polders(0.9, 0.03)
%
% K* values used in Yu et al. study: 0.5, 0.9, 1.2
% z  values used in Yu et al. study: 0.03, 0.45, 0.06
